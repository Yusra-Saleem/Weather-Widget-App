...
export default function WeatherWidget() {
  ...
  return (
    <div className="flex justify-center items-center h-screen bg-purple-300 ">
      <Card className="w-full max-w-md mx-auto text-center rounded-3xl  shadow-xl">
        {/* Card header with title and description */}
        <CardHeader>
          <CardTitle className="text-2xl font-bolder mb-2 text-slate-800 uppercase  ">Weather Widget</CardTitle>
          <CardDescription className="text-slate-700 text-sm mb-4 text-center font-semibold">
        ...
        <CardContent>
          ...
          <form onSubmit={handleSearch} className="flex items-center gap-2">
            <Input
              type="text" className="border-2 border-purple-400 text-slate-700 font-bold text-center rounded-lg"
            ...
            />
            <Button className=" hover:bg-gradient-to-b to-slate-400 from-purple-300 hover:text-slate-800 hover:font-semibold" type="submit" disabled={isLoading}>
